...
% TODO add dates to projects and the repos to the projectrs
% TODO create a master resume with multiple options (role jobs projects), and select the ones relevant to role
% TODO create some tailored projects for job postings with jobs i care about
...
%-----------EDUCATION-----------
% at most three courses for both doulgas and ubc, inline the gpa 
\section{Education}
...
%TODO add in if it was peronsla or ubc/school project
\resumeProjectHeading
%TODO possibly not include the robert nystrom portion
...
%TODO flip debug to first part of sentence, maybe make more clear what im doing with runtime errors, play with it a bit
...
\resumeItem{Wrote Python scripts to generate C\# code for the Lox interpreter, enhancing development speed}
\resumeItemListEnd
...
%TODO if applyign for frontend speak more to the UI/UX
...
\resumeItemListStart
\resumeItem{Developed a desktop fitness tracking application in Java to log workouts, manage routines, and analyze progress}
...
\resumeItemListStart
\resumeItem{Managed teams of three or more to ensure work contracts are completed within given deadlines}
\resumeItem{Engaged in the restoration of concrete foundations and slabs, and service/repair of mechanical equipment}
\resumeItem{Contributed to over \$1M in company revenue by overseeing commercial/residential projects and generating sales}
\resumeItemListEnd
\resumeSubHeadingListEnd
